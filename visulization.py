...
class Visulization(object):
    ...
    def plot_link_buffer_usage(self):
        ...
        plt.subplot(611)
        plt.scatter(global_var.plot_link_rate_time_axis, self.links['L0'].plot_link_rate, s=1)
        plt.xlabel('time(s)')
        plt.ylabel('L0')
        plt.subplot(612)
        plt.scatter(global_var.plot_link_rate_time_axis, self.links['L1'].plot_link_rate, s=1)
        plt.xlabel('time(s)')
        plt.ylabel('L1')
        plt.subplot(613)
        plt.scatter(global_var.plot_link_rate_time_axis, self.links['L2'].plot_link_rate, s = 1)
        plt.xlabel('time(s)')
        plt.ylabel('L2')
        plt.subplot(614)
        plt.scatter(global_var.plot_link_rate_time_axis, self.links['L3'].plot_link_rate, s = 1)
        plt.xlabel('time(s)')
        plt.ylabel('L3')
        plt.subplot(615)
        plt.scatter(global_var.plot_link_rate_time_axis, self.links['L4'].plot_link_rate, s = 1)
        plt.xlabel('time(s)')
        plt.ylabel('L4')
        plt.subplot(616)
        plt.scatter(global_var.plot_link_rate_time_axis, self.links['L5'].plot_link_rate, s = 1)
        plt.xlabel('time(s)')
        plt.ylabel('L5')
        plt.show()
