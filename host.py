...
class Host(Node):
    def __init__(self, host_ipaddr):
        ...
        # key is the neighbor node, value is the outgoing_links
        self.neighbors = {}
        # key is the corresponding flow, value is the first 0's position(this position's pkt has not been acknowleged) in the recieved_pkts_data list
